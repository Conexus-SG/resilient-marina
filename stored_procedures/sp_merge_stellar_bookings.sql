...
BEGIN
    ...
    INSERT INTO DW_STELLAR_BOOKINGS (
    ...
    SELECT 
        src.ID, src.LOCATION_ID, src.CUSTOMER_ID, src.CREATOR_ID, src.ADMIN_ID, src.BILLING_FIRST_NAME, src.BILLING_LAST_NAME, src.BILLING_STREET1, src.BILLING_STREET2, src.BILLING_CITY, src.BILLING_STATE, src.BILLING_COUNTRY, src.BILLING_ZIP, src.CC_SAVED_NAME, src.CC_SAVED_LAST4, src.CC_SAVED_PROFILE_ID, src.CC_SAVED_METHOD_ID, src.CC_SAVED_ADDRESS_ID, src.CC_PREAUTH_ID, src.CC_PREAUTH_AMOUNT, src.CC_CONNECT_TYPE, src.CC_CONNECT_ID, src.ACCESSORIES_CUSTOM_PRICE, src.ACCESSORIES_TOTAL, src.INSURANCE_AMOUNT, src.PETS, src.PARKING, src.PARKING_OVERRIDE, src.BOATS_TOTAL, src.POS_TOTAL, src.USE_CLUB_CREDITS, src.NO_SHOW_FEE, src.CANCELLATION_FEE, src.CLUB_FEES, src.CLUB_FEES_OVERRIDE, src.SUB_TOTAL, src.CONVENIENCE_FEE, src.CONVENIENCE_FEE_WAIVED, src.INTERNAL_APPLICATION_FEE, src.TAX_1, src.TAX_1_EXEMPT, src.TAX_1_RATE_OVERRIDE, src.TAX_2, src.TAX_2_EXEMPT, src.CHECK_IN_TAX_1, src.CHECK_IN_TAX_2, src.CHECK_IN_TOTAL, src.DEPOSIT_TOTAL, src.DEPOSIT_OVERRIDE, src.DEPOSIT_WAIVED, src.GRATUITY, src.GRAND_TOTAL, src.ADJUSTMENT_TOTAL, src.AMOUNT_PAID, src.NOTES, src.NOTES_CONTRACT, src.NOTES_FROM_CUSTOMER, src.NOTES_FROM_CUSTOMER_CONTRACT, src.NOTES_FOR_CUSTOMER, src.NOTES_FOR_CUSTOMER_CONTRACT, src.FRONTEND, src.IS_ON_HOLD, src.IS_LOCKED, src.IS_FINALIZED, src.IS_CANCELED, src.OVERRIDE_TURNAROUND_TIME, src.CANCELLATION_TYPE, src.BYPASS_CLUB_RESTRICTIONS, src.RENTERS_INSURANCE_INTEREST, src.COUPON_ID, src.COUPON_TYPE, src.COUPON_AMOUNT, src.DISCOUNT_TOTAL, src.AGENT_ID, src.AGENT_NAME, src.REFERRER_ID, src.SAFETY_REMINDER, src.DELETED_ADMIN_ID, src.CREATED_AT, src.UPDATED_AT, src.FINALIZED_AT, src.DELETED_AT,
            SYSTIMESTAMP,
            SYSTIMESTAMP
    FROM STG_STELLAR_BOOKINGS src
    WHERE NOT EXISTS (
        SELECT 1 FROM DW_STELLAR_BOOKINGS tgt WHERE tgt.ID = src.ID
    );
    
    p_inserted_count := SQL%ROWCOUNT;
    
    -- Update existing records where data has changed
    UPDATE DW_STELLAR_BOOKINGS tgt
    SET (
        tgt.LOCATION_ID, tgt.CUSTOMER_ID, tgt.CREATOR_ID, tgt.ADMIN_ID, tgt.BILLING_FIRST_NAME, tgt.BILLING_LAST_NAME, tgt.BILLING_STREET1, tgt.BILLING_STREET2, tgt.BILLING_CITY, tgt.BILLING_STATE, tgt.BILLING_COUNTRY, tgt.BILLING_ZIP, tgt.CC_SAVED_NAME, tgt.CC_SAVED_LAST4, tgt.CC_SAVED_PROFILE_ID, tgt.CC_SAVED_METHOD_ID, tgt.CC_SAVED_ADDRESS_ID, tgt.CC_PREAUTH_ID, tgt.CC_PREAUTH_AMOUNT, tgt.CC_CONNECT_TYPE, tgt.CC_CONNECT_ID, tgt.ACCESSORIES_CUSTOM_PRICE, tgt.ACCESSORIES_TOTAL, tgt.INSURANCE_AMOUNT, tgt.PETS, tgt.PARKING, tgt.PARKING_OVERRIDE, tgt.BOATS_TOTAL, tgt.POS_TOTAL, tgt.USE_CLUB_CREDITS, tgt.NO_SHOW_FEE, tgt.CANCELLATION_FEE, tgt.CLUB_FEES, tgt.CLUB_FEES_OVERRIDE, tgt.SUB_TOTAL, tgt.CONVENIENCE_FEE, tgt.CONVENIENCE_FEE_WAIVED, tgt.INTERNAL_APPLICATION_FEE, tgt.TAX_1, tgt.TAX_1_EXEMPT, tgt.TAX_1_RATE_OVERRIDE, tgt.TAX_2, tgt.TAX_2_EXEMPT, tgt.CHECK_IN_TAX_1, tgt.CHECK_IN_TAX_2, tgt.CHECK_IN_TOTAL, tgt.DEPOSIT_TOTAL, tgt.DEPOSIT_OVERRIDE, tgt.DEPOSIT_WAIVED, tgt.GRATUITY, tgt.GRAND_TOTAL, tgt.ADJUSTMENT_TOTAL, tgt.AMOUNT_PAID, tgt.NOTES, tgt.NOTES_CONTRACT, tgt.NOTES_FROM_CUSTOMER, tgt.NOTES_FROM_CUSTOMER_CONTRACT, tgt.NOTES_FOR_CUSTOMER, tgt.NOTES_FOR_CUSTOMER_CONTRACT, tgt.FRONTEND, tgt.IS_ON_HOLD, tgt.IS_LOCKED, tgt.IS_FINALIZED, tgt.IS_CANCELED, tgt.OVERRIDE_TURNAROUND_TIME, tgt.CANCELLATION_TYPE, tgt.BYPASS_CLUB_RESTRICTIONS, tgt.RENTERS_INSURANCE_INTEREST, tgt.COUPON_ID, tgt.COUPON_TYPE, tgt.COUPON_AMOUNT, tgt.DISCOUNT_TOTAL, tgt.AGENT_ID, tgt.AGENT_NAME, tgt.REFERRER_ID, tgt.SAFETY_REMINDER, tgt.DELETED_ADMIN_ID, tgt.CREATED_AT, tgt.UPDATED_AT, tgt.FINALIZED_AT, tgt.DELETED_AT,
        tgt.DW_LAST_UPDATED
    ) = (
        SELECT 
            src.LOCATION_ID, src.CUSTOMER_ID, src.CREATOR_ID, src.ADMIN_ID, src.BILLING_FIRST_NAME, src.BILLING_LAST_NAME, src.BILLING_STREET1, src.BILLING_STREET2, src.BILLING_CITY, src.BILLING_STATE, src.BILLING_COUNTRY, src.BILLING_ZIP, src.CC_SAVED_NAME, src.CC_SAVED_LAST4, src.CC_SAVED_PROFILE_ID, src.CC_SAVED_METHOD_ID, src.CC_SAVED_ADDRESS_ID, src.CC_PREAUTH_ID, src.CC_PREAUTH_AMOUNT, src.CC_CONNECT_TYPE, src.CC_CONNECT_ID, src.ACCESSORIES_CUSTOM_PRICE, src.ACCESSORIES_TOTAL, src.INSURANCE_AMOUNT, src.PETS, src.PARKING, src.PARKING_OVERRIDE, src.BOATS_TOTAL, src.POS_TOTAL, src.USE_CLUB_CREDITS, src.NO_SHOW_FEE, src.CANCELLATION_FEE, src.CLUB_FEES, src.CLUB_FEES_OVERRIDE, src.SUB_TOTAL, src.CONVENIENCE_FEE, src.CONVENIENCE_FEE_WAIVED, src.INTERNAL_APPLICATION_FEE, src.TAX_1, src.TAX_1_EXEMPT, src.TAX_1_RATE_OVERRIDE, src.TAX_2, src.TAX_2_EXEMPT, src.CHECK_IN_TAX_1, src.CHECK_IN_TAX_2, src.CHECK_IN_TOTAL, src.DEPOSIT_TOTAL, src.DEPOSIT_OVERRIDE, src.DEPOSIT_WAIVED, src.GRATUITY, src.GRAND_TOTAL, src.ADJUSTMENT_TOTAL, src.AMOUNT_PAID, src.NOTES, src.NOTES_CONTRACT, src.NOTES_FROM_CUSTOMER, src.NOTES_FROM_CUSTOMER_CONTRACT, src.NOTES_FOR_CUSTOMER, src.NOTES_FOR_CUSTOMER_CONTRACT, src.FRONTEND, src.IS_ON_HOLD, src.IS_LOCKED, src.IS_FINALIZED, src.IS_CANCELED, src.OVERRIDE_TURNAROUND_TIME, src.CANCELLATION_TYPE, src.BYPASS_CLUB_RESTRICTIONS, src.RENTERS_INSURANCE_INTEREST, src.COUPON_ID, src.COUPON_TYPE, src.COUPON_AMOUNT, src.DISCOUNT_TOTAL, src.AGENT_ID, src.AGENT_NAME, src.REFERRER_ID, src.SAFETY_REMINDER, src.DELETED_ADMIN_ID, src.CREATED_AT, src.UPDATED_AT, src.FINALIZED_AT, src.DELETED_AT,
            SYSTIMESTAMP
        FROM STG_STELLAR_BOOKINGS src
        WHERE tgt.ID = src.ID
    )
    WHERE EXISTS (
        SELECT 1 FROM STG_STELLAR_BOOKINGS src
        WHERE tgt.ID = src.ID
        AND (
            ...
            -- OR NVL(tgt.NOTES_CONTRACT, '~') != NVL(src.NOTES_CONTRACT, '~')  -- NCLOB: cannot compare
            -- OR NVL(tgt.NOTES_FROM_CUSTOMER, '~') != NVL(src.NOTES_FROM_CUSTOMER, '~')  -- NCLOB: cannot compare
            -- OR NVL(tgt.NOTES_FROM_CUSTOMER_CONTRACT, '~') != NVL(src.NOTES_FROM_CUSTOMER_CONTRACT, '~')  -- NCLOB: cannot compare
            -- OR NVL(tgt.NOTES_FOR_CUSTOMER, '~') != NVL(src.NOTES_FOR_CUSTOMER, '~')  -- NCLOB: cannot compare
            -- OR NVL(tgt.NOTES_FOR_CUSTOMER_CONTRACT, '~') != NVL(src.NOTES_FOR_CUSTOMER_CONTRACT, '~')  -- NCLOB: cannot compare
    ...
    DBMS_OUTPUT.PUT_LINE('DW_STELLAR_BOOKINGS: Inserted ' || p_inserted_count || ', Updated ' || p_updated_count || ' records');
