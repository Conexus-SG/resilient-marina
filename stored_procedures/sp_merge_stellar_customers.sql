...
BEGIN
    ...
    INSERT INTO DW_STELLAR_CUSTOMERS (
    ...
    SELECT 
        src.USER_ID, src.CLUB_PRINCIPAL_USER_ID, src.COUPON_ID, src.CLUB_TIER_ID, src.FIRST_NAME, src.LAST_NAME, src.MIDDLE_NAME, src.GENDER, src.PHONE, src.CELL, src.EMERGENCY_NAME, src.EMERGENCY_PHONE, src.SECONDARY_EMAIL, src.BILLING_STREET1, src.BILLING_STREET2, src.BILLING_CITY, src.BILLING_STATE, src.BILLING_COUNTRY, src.BILLING_ZIP, src.MAILING_STREET1, src.MAILING_STREET2, src.MAILING_CITY, src.MAILING_STATE, src.MAILING_COUNTRY, src.MAILING_ZIP, src.NUM_KIDS, src.REFERRER, src.SERVICES, src.DATE_OF_BIRTH, src.DL_STATE, src.DL_COUNTRY, src.DL_NUMBER, src.NOTES, src.INTERNAL_NOTES, src.CLUB_STATUS, src.CLUB_START_DATE, src.CLUB_USE_RECURRING_BILLING, src.CLUB_RECURRING_BILLING_START_DATE, src.BALANCE, src.BOAT_DAMAGE_RESPONSIBILITY_COVERAGE, src.PENALTY_POINTS, src.OPEN_BALANCE_THRESHOLD, src.CLUB_END_DATE, src.CC_SAVED_NAME, src.CC_SAVED_LAST4, src.CC_SAVED_EXPIRY, src.CC_SAVED_PROFILE_ID, src.CC_SAVED_METHOD_ID, src.CC_SAVED_ADDRESS_ID, src.EXTERNAL_ID, src.CREATED_AT, src.UPDATED_AT,
            SYSTIMESTAMP,
            SYSTIMESTAMP
    FROM STG_STELLAR_CUSTOMERS src
    WHERE NOT EXISTS (
        SELECT 1 FROM DW_STELLAR_CUSTOMERS tgt WHERE tgt.USER_ID = src.USER_ID
    );
    
    p_inserted_count := SQL%ROWCOUNT;
    
    -- Update existing records where data has changed
    UPDATE DW_STELLAR_CUSTOMERS tgt
    SET (
        tgt.CLUB_PRINCIPAL_USER_ID, tgt.COUPON_ID, tgt.CLUB_TIER_ID, tgt.FIRST_NAME, tgt.LAST_NAME, tgt.MIDDLE_NAME, tgt.GENDER, tgt.PHONE, tgt.CELL, tgt.EMERGENCY_NAME, tgt.EMERGENCY_PHONE, tgt.SECONDARY_EMAIL, tgt.BILLING_STREET1, tgt.BILLING_STREET2, tgt.BILLING_CITY, tgt.BILLING_STATE, tgt.BILLING_COUNTRY, tgt.BILLING_ZIP, tgt.MAILING_STREET1, tgt.MAILING_STREET2, tgt.MAILING_CITY, tgt.MAILING_STATE, tgt.MAILING_COUNTRY, tgt.MAILING_ZIP, tgt.NUM_KIDS, tgt.REFERRER, tgt.SERVICES, tgt.DATE_OF_BIRTH, tgt.DL_STATE, tgt.DL_COUNTRY, tgt.DL_NUMBER, tgt.NOTES, tgt.INTERNAL_NOTES, tgt.CLUB_STATUS, tgt.CLUB_START_DATE, tgt.CLUB_USE_RECURRING_BILLING, tgt.CLUB_RECURRING_BILLING_START_DATE, tgt.BALANCE, tgt.BOAT_DAMAGE_RESPONSIBILITY_COVERAGE, tgt.PENALTY_POINTS, tgt.OPEN_BALANCE_THRESHOLD, tgt.CLUB_END_DATE, tgt.CC_SAVED_NAME, tgt.CC_SAVED_LAST4, tgt.CC_SAVED_EXPIRY, tgt.CC_SAVED_PROFILE_ID, tgt.CC_SAVED_METHOD_ID, tgt.CC_SAVED_ADDRESS_ID, tgt.EXTERNAL_ID, tgt.CREATED_AT, tgt.UPDATED_AT,
        tgt.DW_LAST_UPDATED
    ) = (
        SELECT 
            src.CLUB_PRINCIPAL_USER_ID, src.COUPON_ID, src.CLUB_TIER_ID, src.FIRST_NAME, src.LAST_NAME, src.MIDDLE_NAME, src.GENDER, src.PHONE, src.CELL, src.EMERGENCY_NAME, src.EMERGENCY_PHONE, src.SECONDARY_EMAIL, src.BILLING_STREET1, src.BILLING_STREET2, src.BILLING_CITY, src.BILLING_STATE, src.BILLING_COUNTRY, src.BILLING_ZIP, src.MAILING_STREET1, src.MAILING_STREET2, src.MAILING_CITY, src.MAILING_STATE, src.MAILING_COUNTRY, src.MAILING_ZIP, src.NUM_KIDS, src.REFERRER, src.SERVICES, src.DATE_OF_BIRTH, src.DL_STATE, src.DL_COUNTRY, src.DL_NUMBER, src.NOTES, src.INTERNAL_NOTES, src.CLUB_STATUS, src.CLUB_START_DATE, src.CLUB_USE_RECURRING_BILLING, src.CLUB_RECURRING_BILLING_START_DATE, src.BALANCE, src.BOAT_DAMAGE_RESPONSIBILITY_COVERAGE, src.PENALTY_POINTS, src.OPEN_BALANCE_THRESHOLD, src.CLUB_END_DATE, src.CC_SAVED_NAME, src.CC_SAVED_LAST4, src.CC_SAVED_EXPIRY, src.CC_SAVED_PROFILE_ID, src.CC_SAVED_METHOD_ID, src.CC_SAVED_ADDRESS_ID, src.EXTERNAL_ID, src.CREATED_AT, src.UPDATED_AT,
            SYSTIMESTAMP
        FROM STG_STELLAR_CUSTOMERS src
        WHERE tgt.USER_ID = src.USER_ID
    )
    WHERE EXISTS (
        SELECT 1 FROM STG_STELLAR_CUSTOMERS src
        WHERE tgt.USER_ID = src.USER_ID
        AND (
            ...
            -- OR NVL(tgt.SECONDARY_EMAIL, '~') != NVL(src.SECONDARY_EMAIL, '~')  -- NCLOB: cannot compare
            ...
            -- OR NVL(tgt.INTERNAL_NOTES, '~') != NVL(src.INTERNAL_NOTES, '~')  -- NCLOB: cannot compare
    ...
    DBMS_OUTPUT.PUT_LINE('DW_STELLAR_CUSTOMERS: Inserted ' || p_inserted_count || ', Updated ' || p_updated_count || ' records');
